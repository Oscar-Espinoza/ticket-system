...
- [x] **Phase 5: Tickets Core** - Full ticket CRUD with atomic per-project identifiers and ticket detail page
...
- [x] 03-01-PLAN.md — Foundation: project_member unique constraint + drizzle-kit push, requireProjectOwner seam, Wave-0 RED test suite (MEM-03)

**Wave 2** *(blocked on Wave 1)*

- [x] 03-02-PLAN.md — Invite-link slice: generateInviteLink owner action + members page roster + invite panel (Copy/Regenerate) (MEM-01, MEM-04)
- [x] 03-03-PLAN.md — Accept-invite slice: public /invite/[token] landing + idempotent joinProject (POST-only) (MEM-02)
...
| 5. Tickets Core | DAL + actions + MIMO M5/M7 UI | Complete | 2026-09-24 |
